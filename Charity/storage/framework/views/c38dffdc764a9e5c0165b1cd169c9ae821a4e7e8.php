              ...
              <div class="col-2">
                ...
                <div class="col-10">
                  ...
                  <!-- ================================ links Events Content Start ========================================================================= -->
                   ...
                   <input class="form-control form-control-lg mb-3" type="text" value="<?php echo e($Event->Title_gr); ?>" placeholder="Your Event Title German" name="Title_gr">
                      <textarea class="form-control form-control-lg mb-3" value="<?php echo e($Event->Content_gr); ?>" cols="4" name="Content_gr" placeholder="Your Event Content German"><?php echo e($Event->Content_gr); ?></textarea>
                   </div>
                   <!-- ================================ links Events Content Start ========================================================================= -->
                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                    <input class="form-control form-control-lg mb-3" type="text" value="<?php echo e($Event->Title_ar); ?>" placeholder="Your Event Title Arabic" name="Title_ar">
                      <textarea class="form-control form-control-lg mb-3" value="<?php echo e($Event->Content_ar); ?>" cols="4" name="Content_ar" placeholder="Your Event Content Arabic"><?php echo e($Event->Content_ar); ?></textarea>
                    <!-- ================================ links Events Content Start ========================================================================= -->
                  </div>
                </div>
              </div>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tugasbesarwad\Charity\resources\views/dashboard/dashboardEvents/edit.blade.php ENDPATH**/ ?>
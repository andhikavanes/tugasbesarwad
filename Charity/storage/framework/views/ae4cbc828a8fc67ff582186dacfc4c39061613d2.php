    ...
    <div class="col-lg-9 col-md-12">
      ...
      <div class="card card-small mb-3">
        <div id="form-container" class="card-body">
          <!-- ================================ links Events Content Start ========================================================================= -->
          <form action="<?php echo e(route('dashboardEvents.store')); ?>" method="POST"  role="form" enctype="multipart/form-data" class="add-new-post">
            <?php echo csrf_field(); ?>
            <!-- ================================ links Events Content Start ========================================================================= -->
        ...
        <div class='card card-small mb-3'>
          ...
          <div class='card-body p-0'>
            <ul class="list-group list-group-flush">
              ...
              <a class="btn btn-sm btn-outline-accent" href="<?php echo e(route('dashboardEvents.index')); ?>"><i class="icon-line-awesome-tags"></i> Events</a>
              ...
              <div class='card-body p-0'>
                <ul class="list-group list-group-flush">
                  <div class="edit-post-details__avatar m-auto">
                    <img src="<?php echo e(asset('dashboardassets/images/content-management/cover.png')); ?>" alt="Event Avatar">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tugasbesarwad\Charity\resources\views/dashboard/dashboardEvents/create.blade.php ENDPATH**/ ?>
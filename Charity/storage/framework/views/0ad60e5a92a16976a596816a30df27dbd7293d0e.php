...
<body class="h-100">      
  <div class="container-fluid">
    <div class="row">
          ...
          <div class="nav-wrapper">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
               ...
               <!-- ============================================= Name SiteTitle ============================================= -->
              <li class="nav-item">
                <a class="nav-link " href="<?php echo e(url('dashboard/dashboardMenus')); ?>">
               ...
               <!-- ============================================= Name SiteTitle ============================================= -->
              <li class="nav-item">
                <a class="nav-link " href="<?php echo e(url('dashboard/dashboardAds')); ?>">
            ...
            <nav class="navbar d-flex justify-content-end navbar-light flex-md-nowrap p-0">
              ...
              <footer class="main-footer d-flex p-2 px-3 bg-white border-top">
                <span class="copyright ml-auto my-auto mr-2">Copyright © 2019
                  <a  rel="nofollow"><?php echo e(Setting()->SiteTitle); ?></a>
                </span>
              </footer>
              <!-- ============================================= dashboard content SiteTitle ============================================= -->
            </main>
      ...
      </html><?php /**PATH C:\xampp\htdocs\tugasbesarwad\Charity\resources\views/dashboard/layouts/postmain.blade.php ENDPATH**/ ?>
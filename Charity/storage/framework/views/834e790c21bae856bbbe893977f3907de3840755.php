    ...
    <div class="col-lg-9 col-md-12">
      ...
      <div class="card card-small mb-3">
        <div id="form-container" class="card-body">
          ...
          <form action="<?php echo e(route('dashboardCauses.store')); ?>" method="POST"  role="form" enctype="multipart/form-data" class="add-new-post">
            <?php echo csrf_field(); ?>
            <!-- ================================ dashboard Causes store ========================================================================= -->
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tugasbesarwad\Charity\resources\views/dashboard/dashboardCauses/create.blade.php ENDPATH**/ ?>